...
async def draw_vehicle_img(ev: Event, vehicles: VehicleList, role_name: str):
    ...
    draw.text((title_right, 34), "异环·载具详情", font=nte_font_42, fill=COLOR_WHITE, anchor="ra")
    draw.text(
        (title_right, 96),
        f"{role_name}  ·  {vehicles.own_cnt}/{vehicles.total}",
        font=nte_font_30,
        fill=COLOR_SUBTEXT,
        anchor="ra",
    )

...
async def draw_character_card_img(ev: Event, character: CharacterDetail, role_name: str):
    ...
    draw.text((title_right, 34), "异环·角色详情", font=nte_font_42, fill=COLOR_WHITE, anchor="ra")

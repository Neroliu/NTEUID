...
class LoginMsg:
    ...
    SUCCESS = "登录成功"
    SUCCESS_NO_ROLE = "登录成功！尚未创建角色，进入游戏后再发【签到】即可"
    SUCCESS_ROLES_TITLE = "登录成功！已绑定以下角色："
...
class SignMsg:
    ...
    APP_SIGNED = "塔吉多签到：今日已签"
    APP_DONE = "塔吉多签到：完成"
    GAME_SIGNED = "游戏签到：今日已签"
    GAME_DONE = "游戏签到：完成"
    COMMUNITY_NO_POSTS = "社区任务：暂无可处理内容"
    COMMUNITY_FAILED = "社区任务：失败，稍后再试"
...
class RoleMsg:
    ...
    NO_ROLE = "账号下还没有异环角色，请先在塔吉多绑定异环角色"
